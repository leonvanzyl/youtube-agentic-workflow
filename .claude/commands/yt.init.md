...
**REFERENCE ORGANIZATION**: All supporting materials (articles, documentation, subtitle tracks, research) should be stored in the project's reference folder.
...
2. **Create reference subdirectory**:
   ```
   content/[project-name]/reference/
   ```
...
2. **Project Information**:
   ...
   - Reference Path: `content/[project-name]/reference/`
...
3. **Next Steps Instructions**:
   ...
   1. GATHER REFERENCE MATERIALS
      ...
      Location: content/[project-name]/reference/
...
4. **Workflow Summary**:
   ...
   Next step: Gather reference materials in content/[project-name]/reference/
   ```
...
- [ ] Reference subdirectory created
...
content/
└── [project-name]/
    └── reference/         ← Put your reference materials here
```
...
└─ Reference Path: content/claude-code-plugins/reference/
...
1. GATHER REFERENCE MATERIALS
   ...
   Location: content/claude-code-plugins/reference/
...
You are here: ✓ init (COMPLETED)
Next step: Gather reference materials in content/claude-code-plugins/reference/
```
