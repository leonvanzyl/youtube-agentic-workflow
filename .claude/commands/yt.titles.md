...
2. **Read and extract key information**:
   ...
   - Long-tail keywords (for specific angles)
   - Target audience (for language/tone)
   - Content vibe (for title style)
   - Traffic strategy recommendation (browse vs search focus)
   - Unique value proposition (for differentiation)
   - Competitive analysis (what title styles work in this niche)
   - Hook opportunities (can inform title angles)
...
1. **Load template**: Read `youtube/.youtube/templates/titles-template.md`
...
3. **Write to output file**: `youtube/content/[project-name]/titles.md`
...
```
WARN: "Analysis is missing keyword data. Generating titles with available
information, but search optimization may be limited."
```
